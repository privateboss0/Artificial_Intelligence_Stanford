...
Finally this project can be taken 2-steps further by adding Computer Vision for efficient traffic management of self-driving cars + solar panels + Battery to ensure it is off the grid for Sustainability
